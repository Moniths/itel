            ...
            <div className="grid md:grid-cols-2 gap-8 pt-4 border-t border-slate-100 dark:border-slate-800">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-primary/5 p-4 rounded-lg border border-primary/20">
                  <p className="text-slate-900 dark:text-white font-black text-2xl tracking-wider">923 344 482</p>
                </div>
                <button
                  onClick={copyIban}
                  className="w-full flex items-center justify-center gap-2 rounded-lg h-12 px-6 bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white font-bold transition-all hover:bg-slate-200 dark:hover:bg-slate-700"
                >
