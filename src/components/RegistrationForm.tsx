    ...
    <section className="bg-white dark:bg-slate-900 py-16" id="inscricao">
      <div className="max-w-3xl mx-auto px-4">
        <div className="text-center mb-10">
          <h2 className="text-slate-900 dark:text-white text-3xl font-black mb-3">Formulário de Inscrição</h2>
          <p className="text-slate-500 dark:text-slate-400">Preencha os dados abaixo para garantir o seu lugar no evento.</p>
        </div>
